...
class Amplitude {
  ...
  addToUserProperty(property, amount) {
    if (amplitudeHasInitialized) {
      ...
      throw new Error(
        "You called Amplitude.addToUserProperty before initializing it. Run new Amplitute(key) first."
      );
    }
  }
  ...
  appendToUserProperties(key, value) {
    if (amplitudeHasInitialized) {
      RNAmplitudeSDK.appendToUserProperties(key, value);
    } else {
      throw new Error(
        "You called Amplitude.appendToUserProperties before initializing it. Run new Amplitute(key) first."
      );
    }
  }

  prependToUserProperties(key, value) {
    if (amplitudeHasInitialized) {
      RNAmplitudeSDK.prependToUserProperties(key, value);
    } else {
      throw new Error(
        "You called Amplitude.prependToUserProperties before initializing it. Run new Amplitute(key) first."
      );
    }
  }
}
